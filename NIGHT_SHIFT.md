...
- WAVE 6 REMAINING: (v) cmd+k command palette quick search (global, fetches /api/prompts?q=); (x) editable profile bio + links (settings → /u/[handle]). NEXT: cmd+k command palette.
