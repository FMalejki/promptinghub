...
- WAVE REMAINING after #37: (b) RSS/Atom feed of trending; (c) free-form tags alongside categories; (d) version diff (v1↔v2); (e) real account deletion (settings stub is fake). NEXT: RSS feed.
